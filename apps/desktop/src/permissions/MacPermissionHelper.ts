...
<header>↑ Drag Otter Code into the list above</header>
<button id="app" draggable="true" aria-label="Drag Otter Code to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Otter Code</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Otter Code icon is missing.");
