...
function SubscriptionUsage(
  ...
  const providers = props.providers ?? [
    { name: "Codex", detail: "Open Otter Code to connect", windows: [], expiresAt: 0 },
    { name: "Claude", detail: "Open Otter Code to connect", windows: [], expiresAt: 0 },
  ];
