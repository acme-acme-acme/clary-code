    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription>
            Otter Code needs your SSH password to connect to <code>{target}</code>. The password is
            passed to the local SSH process for this connection attempt and is not saved by Otter
            Code.
          </DialogDescription>
        </DialogHeader>
