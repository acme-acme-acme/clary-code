...
import {
  ...
  type LinkThreadLinearIssueInput,
  ...
  type UnlinkThreadLinearIssueInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    linkLinearIssue: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:link-linear-issue",
      execute: (input: LinkThreadLinearIssueInput) => linkThreadLinearIssue(input),
      scheduler,
      concurrency,
    }),
    unlinkLinearIssue: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:unlink-linear-issue",
      execute: (input: UnlinkThreadLinearIssueInput) => unlinkThreadLinearIssue(input),
      scheduler,
      concurrency,
    }),
