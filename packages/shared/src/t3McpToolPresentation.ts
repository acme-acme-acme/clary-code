...
const T3_MCP_TOOLS: Readonly<Record<string, T3McpToolDefinition>> = {
  ...
  create_threads: tool(["Create", "Creating", "Created", "Otter Code threads"], "thread-create"),
  t3_thread_start: tool(["Start", "Starting", "Started", "an Otter Code thread"], "thread-create"),
  t3_thread_list: tool(["List", "Listing", "Listed", "Otter Code threads"], "thread-list"),
  t3_thread_read: tool(["Read", "Reading", "Read", "an Otter Code thread"], "thread-read"),
  t3_thread_send: tool(["Send", "Sending", "Sent", "to an Otter Code thread"], "thread-send"),
  t3_thread_wait: tool(["Wait", "Waiting", "Waited", "for an Otter Code thread"], "thread-wait"),
  t3_thread_interrupt: tool(
    ["Interrupt", "Interrupting", "Requested an interrupt of", "an Otter Code thread"],
    "thread-interrupt",
  ),
  ...
  t3_thread_update: tool(
    ["Update", "Updating", "Updated", "Otter Code thread metadata"],
    "thread-update",
  ),
